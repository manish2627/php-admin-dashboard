...
if (isset($_SESSION['logedin'])) {
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($count == 1) {
      ...
      $_SESSION['crud_msg'] = "invalid. please check your details ....!!";
    }
  }
    ...
    <div class="container">
      ...
      $_SESSION['crud_msg'] = false;
                    ...
                    <form class="user" action="login.php" method="POST">
                      <div class="form-group"><input class="form-control form-control-user" type="email" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Email Address..." name="email" value="<?php if (!empty($useremail)) {
                                                                                                                                                                                                                        echo $useremail;
                                                                                                                                                                                                                      } ?>"></div>
