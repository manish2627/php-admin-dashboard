...
if (isset($_SESSION['logedin'])) {
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if (empty($_POST['dob'])) {
            $errdob = "date of birth is requird";
        } else {
            $dob = $_POST['dob'];
        }
                        ...
                        <div class="col-lg-7">
                            <div class="p-5">
                                ...
                                <form class="user" action="register.php" method="POST">
                                    ...
                                    <div class="form-group"><input class="form-control form-control-user" type="email" id="email" name="email" value="<?php echo $email ?>" aria-describedby=" emailHelp" placeholder="Email Address"><span class="error">
                                            <h6><?php echo $erremail; ?></h6>
                                        </span></div>
                                    <div class="form-group row">
                                        <div class="col-sm-6 mb-3 mb-sm-0"><input class="form-control form-control-user" type="tel" id="phone" placeholder="phone" name="phone" value="<?php echo $phone ?>"><span class="error">
                                                <h6><?php echo $errphone; ?></h6>
                                            </span></div>
                                        <div class="col-sm-6"><input class="form-control form-control-user" type="date" id="dob" placeholder="date of birth" name="dob" value="<?php echo $dob ?>"><span class="error">
                                                <h6><?php echo $errdob; ?></h6>
                                            </span></div>
                                    </div>
                                    <div class="form-group row">
